...
public static class Q02
{
	...
	public static void Main()
	{
		...
		while(!WindowShouldClose())
		{
			...
			DrawText( $"Distancia centro a centro: { dist }u", 20, 20, 20, Color.Blue );
			DrawText( $"Distancia: { dist - p1.GetRadius() * 2 }u", 20, 40, 20, Color.Blue );
			DrawText( $"O raio de ambos os pontos é: { p1.GetRadius() }u", 20, 60, 20, Color.Blue );
			EndDrawing();
		}
